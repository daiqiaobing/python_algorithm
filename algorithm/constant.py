...
FIND_REPEAT_STR_CODER = ["coder",
                         ...
                         "focoderqbnacoderkmnuicoderimdcoderwkcoderqsyhcoderfuzqcoderzsncodersigocoder", "lhkscoder",
                         ...
                         "xqoaxcoderwcoderrxcucoderplcodermmsjwcoderyfcoderscodervnacoder", "vqicoderlcoderecoder",
                         ...
                         "pscodernvtwgcoder", "kcodereewcoderrcoderzccoderkacodermbqaccoder",
...
SORT_ARR = [2, 1, 34, 5, 7, 8, 43, 23, 45, 44, 12]
SORT_SMALL_LARGE = [45, 44, 43, 34, 23, 12, 8, 7, 5, 2, 1]
SORT_LARGE_SMALL = [1, 2, 5, 7, 8, 12, 23, 34, 43, 44, 45]

SORT_ARR1 = [19, 1, 34, 5, 7, 8, 43, 23, 45, 44, 12]
SORT_SMALL_LARGE1 = [45, 44, 43, 34, 23, 19, 12, 8, 7, 5, 1]
SORT_LARGE_SMALL1 = [1, 5, 7, 8, 12, 19, 23, 34, 43, 44, 45]
